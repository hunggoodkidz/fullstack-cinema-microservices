                                    ...
                                    <Form className='row justify-content-center align-items-start'>
                                        <div className='col-sm-12 col-md-6'>
                                            <div class="imput-group form-floating has-validation mb-3">
                                                <TextInput name="fullName" type="text" class="form-control" id="fullName" placeholder="Full name" required/>
                                                <label for="fullName">Please sign your full Name</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <TextInput name="email" type="email" class="form-control" id="email" placeholder="Email" required/>
                                                <label for="email">Email</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <TextInput name="phone" type="tel" class="form-control" id="phone" placeholder="0 5** *** ** **" required/>
