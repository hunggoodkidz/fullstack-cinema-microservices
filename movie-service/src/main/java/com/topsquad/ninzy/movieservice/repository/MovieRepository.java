...
public interface MovieRepository extends JpaRepository<Movie, Integer> {
    ...
    @Query("Select new com.topsquad.ninzy.movieservice.entity.dto.MovieResponseDto(m.movieId, m.movieName, m.description, m.duration," +
    ...
    @Query("select new com.topsquad.ninzy.movieservice.entity.dto.MovieResponseDto(" +
